## Test 
print('''Sprawdznie rejestracji użytkownika bez podania nazwiska użytkownika.
...
rejestruj.click()
time.sleep(1)
przegladarka.save_screenshot('TST_02_7.png')
...
if "NIE WYPEŁNIONO" in tekstKomunikatu:
    ...
    print("Wyświetlony komunikat błędu to:\n" + tekstKomunikatu)
print("Screen z wyniekiem testu znajduje się w pliku TST_02_7.png")
