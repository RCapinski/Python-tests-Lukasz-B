## Test 
print('''Sprawdznie rejestracji użytkownika bez podania kodu grupy użytkownika.
...
rejestruj.click()
time.sleep(1)
przegladarka.save_screenshot('TST_02_8.png')
...
print("Screen z wyniekiem testu znajduje się w pliku TST_02_8.png")
