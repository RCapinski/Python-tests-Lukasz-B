## Test 
print('''Sprawdznie rejestracji użytkownika bez podania hasła użytkownika.
...
rejestruj.click()
time.sleep(1)
przegladarka.save_screenshot('TST_02_4.png')
...
if "NIE WYPEŁNIONO" in tekstKomunikatu:
    ...
    print("Wyświetlony komunikat to:\n\n" + tekstKomunikatu)
print("Screen z wyniekiem testu znajduje się w pliku TST_02_4.png")
