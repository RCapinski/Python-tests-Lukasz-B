## Test 1
print('''Stworzenie konta z niedozwolonymi znakami w imieniu i nazwisku.
Scenariusz negatywn - oczekujemy błedu logowania.\n''')
...
rejestruj.click()
time.sleep(1)
przegladarka.save_screenshot('TST_02_12.png')
...
if "REJESTRACJA PRZEBIEGŁA POMYŚLNIE" in tekstKomunikatu:
    ...
    print("Wyświetlony komunikat to:\n" + tekstKomunikatu)
print("Screen z wyniekiem testu znajduje się w pliku TST_02_12.png")
