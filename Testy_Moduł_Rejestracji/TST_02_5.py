## Test 
print('''Sprawdznie rejestracji użytkownika bez podania powtórzenia hasła użytkownika.
Scenariusz negatywny - oczekujemy błedu logowania\n''')
...
rejestruj.click()
time.sleep(1)
przegladarka.save_screenshot('TST_02_5.png')
...
if "NIE WYPEŁNIONO" in tekstKomunikatu:
    ...
    print("Wyświetlony komunikat to:\n" + tekstKomunikatu)
print("Screen z wyniekiem testu znajduje się w pliku TST_02_5.png")
